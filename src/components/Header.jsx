  ...
  return (
    <header className="header">
      ...
      <button id="hamburger-button" onClick={toggleMenu}>
        <img
          src={`/src/assets/images/${isMenuOpen ? 'x-close.png' : 'menu-01.png'}`}
          alt="Menu"
        />
      </button>
      ...
      <nav className={`header__navbar ${isMenuOpen ? 'show' : ''}`}>
        <ul className="header__list">
          ...
          <li className="header__item">
            <Link to="/blog" className="header__item-link">Blog</Link>
          </li>
          <li className="header__item">
            <Link to="/about" className="header__item-link">About</Link>
          </li>
          <li className="header__item">
            <Link to="/newsletter" className="header__item-link">Newsletter</Link>
          </li>
        </ul>
      </nav>
      ...
      <button className="header__toggle" onClick={toggleTheme}>
        <img
          src={`/src/assets/images/icon-${isDarkMode ? 'sun' : 'moon'}.svg`}
